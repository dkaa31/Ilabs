    ...
    <div class="bg-white rounded shadow-sm p-3">
        ...
        <form method="GET" action="{{ route('admin.user-sessions') }}" class="mb-4">
            <div class="d-flex gap-2">
                ...
                <input type="text" name="keyword" class="form-control" placeholder="Cari nama user..."
                ...
                <tbody>
                    @forelse($activeSessions as $session)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin.user-sessions.destroy', $session) }}" method="POST"
                                    style="display:inline;" onsubmit="return confirm('Logout user ini?')">
