    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex flex-wrap gap-3 justify-content-center">
                <div class="card border-0 shadow-sm rounded-3 text-center" style="width: 170px; height: 120px; padding: 16px;">
                    <div class="mx-auto bg-primary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center" style="width: 52px; height: 52px;">
                ...
                <div class="card border-0 shadow-sm rounded-3 text-center" style="width: 170px; height: 120px; padding: 16px;">
                    <div class="mx-auto bg-success bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center" style="width: 52px; height: 52px;">
                ...
                <div class="card border-0 shadow-sm rounded-3 text-center" style="width: 170px; height: 120px; padding: 16px;">
                    <div class="mx-auto bg-info bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center" style="width: 52px; height: 52px;">
                ...
                <div class="card border-0 shadow-sm rounded-3 text-center" style="width: 170px; height: 120px; padding: 16px;">
                    <div class="mx-auto bg-warning bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center" style="width: 52px; height: 52px;">
                ...
                <div class="card border-0 shadow-sm rounded-3 text-center" style="width: 170px; height: 120px; padding: 16px;">
                    <div class="mx-auto bg-purple bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center" style="width: 52px; height: 52px;">
                ...
                <div class="card border-0 shadow-sm rounded-3 text-center" style="width: 170px; height: 120px; padding: 16px;">
                    <div class="mx-auto bg-secondary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center" style="width: 52px; height: 52px;">
