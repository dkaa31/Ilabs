...
<div class="card shadow-sm">
    ...
    <form method="POST" action="{{ route('absensi.data.filter') }}" class="mb-4">
@csrf
<div class="d-flex gap-2">
    ...
    {{-- Reset --}}
    <a href="{{ route('absensi.data') }}" class="btn btn-secondary px-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                @else
                                    <span class="badge bg-info">{{ Str::limit($data['status_tampil'], 8, '') }}</span>
                                @endif
                            </td>
                        </tr>
                        @empty
